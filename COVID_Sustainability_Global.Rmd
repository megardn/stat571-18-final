...
stargazer(lm.econ.1, lm.econ.1.refined, lm.econ.2.refined, lm.econ.3.refined, type = "html")
...
stargazer(lm.covid.1, lm.covid.1.refined, lm.covid.2.refined, type = "html")
```
...
#summary(fit.1se.lm) 
stargazer(fit.1se.lm, type = "html")
```
