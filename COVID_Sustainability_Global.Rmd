...
Predicting VSI scores (from `data/VaccinationSucessIndexData-New.csv`) using `case.wsd.wide`, which includes all WSD summary outputs and COVID case/death info up until vaccination started in each country.
