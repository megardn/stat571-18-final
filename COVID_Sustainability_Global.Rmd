...
pacman::p_load(tidyverse, dplyr, ggplot2, ggthemes, data.table, lubridate,
               ...
               rworldmap, RColorBrewer, classInt)
```
...
Merge into one wide wsd dataframe and remove any variables that are highly correlated:
...
**ahhh keeps changing and mse going up from mse train!**
...
Hurrah! Our training MSE from our ensemble method, `r en.train.mse`, is actually pretty good!
