...
colnames(last.timepoint)[2:44] <- paste(colnames(last.timepoint)[2:44], "last", sep = "_") #add suffix
...
#grab just case/death stuff from last.timepoint
...
```{r}
covid.df_list <- list(case.sum.wide, vac.sum.wide)
...
#adding in PC1
yval <- new.data.with.VSI %>% select("country", "VSI")
