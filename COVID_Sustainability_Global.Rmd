...
** Policy Recommendation: This may indicate a nation's gender-based social liberality. Aid should thus be considered for nations that are **needs end of sentence - ex: nations that are socially more conservative? ~ what about "Initiatives to promote womens' equality and educational attainment may also have secondary benefits to vaccination and similar public-health campaigns." **
* Regime Type
...
We'll write our final, cleaned dataset by joining our WSD predictors, prevaccination COVID case and death predictors, and the VSI. 
...
Upon merging, we are left with data on `n_unique(final.df$country)` unique countries.
...
Now we'll attempt to create the best model by bagging those created above, averaging the predicted VSI values from each model.
